...
public class OpenSocialRequestValidator {
   ...
   */
  public static boolean verifyHmacSignature(HttpServletRequest request, String
  ...
  public static boolean verifyRsaSignature(HttpServletRequest request, String
      certificate) throws IOException, URISyntaxException {
