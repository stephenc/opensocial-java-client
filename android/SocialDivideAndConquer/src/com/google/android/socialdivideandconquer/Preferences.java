...
public class Preferences extends PreferenceActivity {
    ...
    public static final String KEY_SNS = "key_sns";
    public static final String KEY_SNS_VALUE = "key_sns_va" +
            "lue";
    ...
    private PreferenceScreen createPreferenceHierarchy() {
        ...
        // social network on/off
        /*
        CheckBoxPreference snsPref = new CheckBoxPreference(this);
        snsPref.setDefaultValue(false);
        snsPref.setKey(KEY_SNS);
        snsPref.setTitle(R.string.settings_sns);
        snsPref.setSummary(R.string.settings_sns_summary);
        root.addPreference(snsPref);
        */
        
        // social network chooser
        SocialNetworkChooserListPreference networkPref  = new SocialNetworkChooserListPreference(this);
        networkPref.setTitle("Social network");
        networkPref.setKey(KEY_SNS_VALUE);
        networkPref.setSummary("Choose a network you'd like to connect to this app");
        root.addPreference(networkPref);
