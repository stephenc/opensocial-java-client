...
public class OpenSocialActivity {
  ...
  public OpenSocialClient getOpenSocialClient() {
    ...
    String providerString = prefs.getString(SocialNetworkChooserListPreference.CURRENT_PROVIDER_PREF, null);
    ...
    if (intent.getData() != null && PreferenceManager.getDefaultSharedPreferences(context).contains(SocialNetworkChooserListPreference.REQUEST_TOKEN_PREF)) {
      try {
      ...
      // remove initial request token
      SharedPreferences.Editor editor = prefs.edit();
      editor.remove(SocialNetworkChooserListPreference.REQUEST_TOKEN_PREF);
      editor.remove(SocialNetworkChooserListPreference.REQUEST_TOKEN_SECRET_PREF);
      editor.commit();
    }
  ...
  private void setupUsersOauthToken(Map<OpenSocialProvider, Token> supportedProviders,
    ...
    oauthLibrary.putExtra(SocialNetworkChooserListPreference.ANDROID_SCHEME,
        browserScheme);
    oauthLibrary.putStringArrayListExtra(SocialNetworkChooserListPreference.PROVIDERS,
        providerStrings);
    try {
  ...
  */
  ...
  private Token loadRequestToken() {
    String requestTokenPref = prefs.getString(SocialNetworkChooserListPreference.REQUEST_TOKEN_PREF, null);
    if (requestTokenPref != null) {
      String requestTokenSecretPref = prefs.getString(
              SocialNetworkChooserListPreference.REQUEST_TOKEN_SECRET_PREF, "");
